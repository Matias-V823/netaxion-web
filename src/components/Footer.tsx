        ...
        <footer className="bg-zinc-950 py-10 mt-10">
            <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
                ...
                <div>
                    ...
                    <div className="flex justify-center md:justify-start space-x-4 mt-3 text-xl text-slate-400">
                ...
                <div>
                    ...
                    <p className="text-sm text-slate-400 mb-2">Visítanos en nuestra oficina en Providencia</p>
                    ...
                    <p className="text-xs text-slate-500 mt-2">Horario: Lun - Vie 8:00 - 18:00</p>
                </div>
            </div>

            <div className="border-t border-zinc-800 mt-8 pt-4 text-center text-sm text-slate-500">
